...
void skills() {
    ...
    Loader.extend();
    pros::delay(500);
    while (frontDistance.get_distance() > 1200) {pros::delay(1);}
    DescoreArm.retract();
    chassis.tank(0, 0);
    ...
    Loader.retract();
    chassis.turnToPoint(-28, 29, 1500, {.minSpeed=50});
    chassis.waitUntilDone();
    chassis.moveToPoint(-28, 29, 3000, {.minSpeed=5, .earlyExitRange=3});
    chassis.waitUntilDone();
    chassis.turnToPoint(-11, 11, 1500, {.forwards=false});
    Loader.extend();
    chassis.waitUntilDone();
    chassis.moveToPoint(-11, 11, 4000, {.forwards=false, .maxSpeed=85});
    Intake.Out();
    chassis.waitUntil(8);
    Intake.Stop();
    chassis.waitUntilDone();
    ...
    Intake.In();
    chassis.moveToPoint(-54, 47, 2500, {.minSpeed=50, .earlyExitRange=2});
    chassis.waitUntilDone();
    chassis.moveToPoint(-60, 47, 2500, {.maxSpeed=40});
    chassis.waitUntilDone();
    chassis.tank(50,50);
    pros::delay(2000);
    chassis.tank(0, 0);
    ...
    chassis.waitUntilDone();
    Intake.Stop();
    chassis.moveToPoint(48, -41, 5000, {.minSpeed=50, .earlyExitRange=3});
    chassis.moveToPoint(48, -48, 4500, {.maxSpeed=100});
    chassis.waitUntilDone();
    ...
    chassis.waitUntilDone();
    chassis.turnToPoint(-30, -47, 1500, {.forwards=false});
    chassis.waitUntilDone();
    chassis.moveToPoint(-31, -47, 2500, {.forwards=false});
    chassis.waitUntilDone();
    chassis.tank(-127, -127);
    pros::delay(750);
    chassis.tank(0, 0);
