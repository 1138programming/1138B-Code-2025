...
void soloPleaseHit() {
    ...
    chassis.tank(0, 0);
    Loader.retract();
    // moveRelative(6, 127, 127, 750);
    // chassis.turnToPoint(-24, -24, 750, {.minSpeed=50});
    // chassis.waitUntilDone();
    chassis.moveToPoint(-22, -24, 1250, {.minSpeed=20, .earlyExitRange=6});
    Intake.In();
    chassis.waitUntil(16);
    Loader.extend();
    chassis.moveToPoint(-23, 24, 1000, {.minSpeed=30});
    ...
    chassis.turnToPoint(-11.5, 11.5, 750, {.forwards=false, .minSpeed=30});
    chassis.waitUntilDone();
    chassis.moveToPoint(-11.5, 11.5, 1000, {.forwards=false});
    chassis.waitUntilDone();
    Intake.ScoreMid();
    pros::delay(1000);
    chassis.moveToPoint(-48, 48, 1250, {.minSpeed=50});
    Intake.MidIn();
    ...
    chassis.waitUntilDone();
    Intake.In();
    chassis.moveToPoint(-58, 48, 750, {.minSpeed=50});
    chassis.waitUntilDone();
    chassis.tank(25, 25);
    pros::delay(350);
    chassis.tank(0, 0);
...
void right7() {
    chassis.setPose(-48, -17, 90);
    Intake.In();
    chassis.moveToPoint(-24, -24, 2500, {.minSpeed=127, .earlyExitRange=6});
    chassis.waitUntil(10);
    Loader.extend();
    chassis.waitUntilDone();
    straightLine(-50, -51, 1250, 2500, {.minSpeed=60, .earlyExitRange=25});
    chassis.waitUntilDone();
    chassis.turnToHeading(270, 1500, {.minSpeed=30});
    chassis.waitUntilDone();
    chassis.moveToPoint(-60, -51, 1500, {.minSpeed=60});
    chassis.waitUntilDone();
    // wiggle(450);
    chassis.tank(60, 60);
    pros::delay(450);
    chassis.tank(0, 0);
    chassis.moveToPoint(-30, -51, 2500, {.forwards=false, .minSpeed=75});
    Intake.Out();
    chassis.waitUntil(3);
    Intake.Stop();
    chassis.waitUntilDone();
    ...
    Intake.Stop();
    chassis.tank(0, 0);
    chassis.moveToPoint(-38, -51, 1500, {.minSpeed=127, .earlyExitRange=2});
    chassis.waitUntilDone();
    straightLine(-30, -60, 1000, 2000, {.forwards=false, .minSpeed=60, .earlyExitRange=3}, {.forwards=false, .minSpeed=50});
    chassis.waitUntilDone();
    chassis.moveToPoint(-6, -60, 2000, {.forwards=false, .minSpeed=40});
    chassis.waitUntilDone();
    chassis.turnToHeading(285, 1500, {.maxSpeed=75});
    chassis.waitUntilDone();
}
...
void left7splitWing() {
    ...
    Intake.In();
    chassis.moveToPoint(-24, 24, 2500, {.minSpeed=127});
    chassis.waitUntil(10);
    Loader.extend();
    chassis.waitUntilDone();
    straightLine(-11.5, 11.5, 1500, 2500, {.forwards=false, .minSpeed=50}, {.forwards=false, .minSpeed=50});
    chassis.waitUntilDone();
    Intake.ScoreMid();
    pros::delay(1500);
    ...
    Intake.Stop();
    chassis.waitUntilDone();
    chassis.turnToHeading(270, 1500, {.minSpeed=50});
    Loader.extend();
    chassis.waitUntilDone();
    Intake.In();
    chassis.moveToPoint(-59, 48, 1500, {.minSpeed=60});
    chassis.waitUntilDone();
    chassis.tank(50, 50);
    pros::delay(500);
    chassis.tank(0, 0);
    ...
    pros::delay(1000);
    chassis.tank(0, 0);
    chassis.moveToPoint(-40, 48, 1500, {.minSpeed=127});
    Intake.Stop();
    chassis.waitUntilDone();
    straightLine(-30, 37, 1500, 2500, {.forwards=false, .minSpeed=60, .earlyExitRange=3}, {.forwards=false, .minSpeed=80});
    chassis.waitUntilDone();
    straightLine(-12, 37, 2000, 2000, {.forwards=false, .minSpeed=75, .earlyExitRange=3}, {.forwards=false, .minSpeed=75});
    // chassis.moveToPoint(-10, 37, 2000, {.forwards=false, .minSpeed=80});
    chassis.waitUntilDone();

}

void split7DihWing() {
    chassis.setPose(-47.5, 6.5, 0);
    chassis.moveToPoint(-47.5, 48, 2000, {.minSpeed=40});
    chassis.waitUntilDone();
    Loader.extend();
    chassis.turnToHeading(270, 1000, {.minSpeed=20});
    chassis.waitUntilDone();
    Intake.In();
    chassis.moveToPoint(-59, 48, 1000, {.minSpeed=60});
    chassis.waitUntilDone();
    chassis.tank(60, 60);
    pros::delay(500);
    chassis.tank(0, 0);
    ...
    chassis.waitUntilDone();
    straightLine(-14, 10, 1000, 1500, {.forwards=false}, {.forwards=false, .minSpeed=50});
    chassis.waitUntilDone();
    Intake.ScoreMid();
    pros::delay(1250);
    moveRelative(10, 127, 127, 750);
    MidDescoreArm.extend();
    chassis.waitUntilDone();
    moveRelative(-10, 127, 100, 750);
    chassis.waitUntilDone();
    MidDescoreArm.retract();
    chassis.moveToPoint(-36, 35, 1500, {.minSpeed=50});
    chassis.waitUntilDone();
    straightLine(-8, 35, 750, 5000, {.forwards=false}, {.forwards=false});
    chassis.waitUntilDone();
