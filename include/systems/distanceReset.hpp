...
constexpr double FRONT_SENSOR_OFFSET = 2; 
constexpr double BACK_SENSOR_OFFSET = 0.5;   
constexpr double LEFT_SENSOR_OFFSET = -5.75;   
constexpr double RIGHT_SENSOR_OFFSET = 5.5;  
