...
constexpr double FRONT_SENSOR_OFFSET = 3.625; 
constexpr double BACK_SENSOR_OFFSET = 0;
constexpr double LEFT_SENSOR_OFFSET = 5.625;   
constexpr double RIGHT_SENSOR_OFFSET = 5.25;  
